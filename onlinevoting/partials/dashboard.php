...
if (!isset($_SESSION['id'])) {
    header('location:../');
    exit(); // Add this to stop execution if the user is not logged in
}
...
<body class="bg-secondary text-light">
    ...
    ?>
                <div class="row">
                    <div class="col md-4">
                        <img src="../uploads/<?php echo $groups[$i]['photo'] ?>" alt="Group Image" srcset="">
                    </div>
                    <div class="col md-8">
        ...
        ?>
            ...
            <div class="col md-5">
                <!-- users -->
                <img src="../uploads/<?php echo $data['photo'] ?>" alt="User Image" srcset="">
                <br>
                <br>
